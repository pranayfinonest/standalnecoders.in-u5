    ...
    <div className="py-12 sm:py-16 md:py-20">
      <ResponsiveContainer>
        ...
        <div className="mb-16 bg-gray-50 dark:bg-gray-800 rounded-2xl overflow-hidden shadow-md">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-4">{caseStudiesData[0].title}</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-6">{caseStudiesData[0].summary}</p>
              <Button asChild size="lg">
                <Link href={`/case-studies/${caseStudiesData[0].slug}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {caseStudiesData.slice(1).map((caseStudy) => (
